  ...
  <div class="welcome-screen">
      ...
      <div class="brand-frame">
        <div class="logo-horizontal">
          <div class="logo-container">
            ...
            <img src="/src/assets/sauron-logo.svg" width="40" height="40" class="logo logo-dark" alt="Sauron Logo">
            <!-- Dark mode logo -->
            <img src="/src/assets/sauron-logo-light.svg" width="40" height="40" class="logo logo-light" alt="Sauron Logo Light">
          </div>
    ...
    <div class="actions">
      ...
      <div class="email-actions">
        <button class="email-btn primary" @click="$emit('showLogin')">
          Sign in with email
        </button>
